...
public interface PropisService extends CrudService<Propisi>
{
	 ...
	 * @param requestData podaci sa klijenta
	 * @return
	 */
	 ...
	 * @param doc dokument xml cije podatke hocemo da prikazemo
	 * @param fileForXsl xsl koji smo specijalno napravili za prikaz propisa
	 * @return
	 ...
	 * @param file lokacija keystore-a
	 * @param alias 
	 * @param password
	 * @return
	 */
	 ...
	 * @param file lokacija gde se nalazi certifikat
	 * @param certNaziv naziv sertifikata
	 * @return
	 */
	 ...
	 * @param doc dokument koji se potpisuje
	 * @param privateKey
	 * @param cert
	 * @return
	...
	/**
	 * Vrsi se enkripcija dokumenta simetricnim algoritmom,
	 * kao i sifrovanje tajnog kljuca simetricnim algoritmom 
	 * @param doc
	 * @param key
	 * @param certificate
	 ...
	 * @param xmlDocument koji zelimo da enkriptujemo
	 * @param jks javakeystore koji koristimo
	 * @throws IOException 
	 */
	 ...
	 * @param doc dokument koji je enkriptovan
	 * @param privateKey kojim je kriptovan
