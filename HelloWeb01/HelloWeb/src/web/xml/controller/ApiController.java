...
public class ApiController {
	...
	/*
	 * //Pokusaj redirekcije, ali isto radi kao i klasa gore, ali ovo je jedino
	 * sto sam nasao da je obecavalo da ce raditi public ResponseEntity<Object>
	 * login( final HttpServletRequest req, final HttpServletResponse res)
	 ...
	 * 
	 * try { Claims claims =
	 * Jwts.parser().setSigningKey("asdf").parseClaimsJws(token).getBody();
	 * 
	 * //System.out.println(claims.getId());
	 * 
	 * String rola = (String) claims.get("roles"); //return new
	 * RoleUsername(rola, claims.getSubject()); return new
	 * ResponseEntity<Object>(new RoleUsername(rola, claims.getSubject()),
	 ...
	 * 
	 * URI uri = new
	 * URI("http://localhost:8080/HelloWeb/pages/index.html#/login");
	 * HttpHeaders httpHeaders = new HttpHeaders();
	 * httpHeaders.setLocation(uri); return new
	 * ResponseEntity<Object>(httpHeaders, HttpStatus.SEE_OTHER);
	 * 
	 * }
	 */
