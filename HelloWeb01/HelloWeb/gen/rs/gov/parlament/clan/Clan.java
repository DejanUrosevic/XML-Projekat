...
public class Clan {
    ...
    public static class Sadrzaj {
        ...
        public static class Tekst {
            ...
            @XmlElement(name = "IDPropisa")
            @XmlSchemaType(name = "positiveInteger")
            protected BigInteger idPropisa;
            @XmlElement(name = "NazivPropisa")
            protected String nazivPropisa;
            @XmlElement(name = "IDClana")
            @XmlSchemaType(name = "positiveInteger")
            protected BigInteger idClana;
            @XmlElement(name = "NazivClana")
            protected String nazivClana;
            @XmlElement(name = "RedniBrojStava", type = Long.class)
